                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $insertPengembalian = "INSERT INTO tbpengembalian (id_pengembalian, tanggal_pengembalian, denda, id_buku, id_anggota, id_petugas) VALUES ('', '$tanggal_pengembalian', '$denda', '$id_buku', '$id_anggota', '$id_petugas')";
                            $updateStatus = "UPDATE tbanggota SET status = 'Tidak Meminjam' WHERE id_anggota = '$id_anggota'";
                            $deletePeminjaman = "DELETE FROM tbpeminjam WHERE id_peminjaman = '$id_peminjaman'";

                            if ($conn->query($insertPengembalian) == TRUE) {
                                // update status peminjam
                                $conn->query($updateStatus);
                                // delete data peminjaman
                                $conn->query($deletePeminjaman);
